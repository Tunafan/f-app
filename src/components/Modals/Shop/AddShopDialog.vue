...
async function onSubmitForm() {
  ...
  try {
    ...
    const response = await fetch('https://tdjwzjdbrubfdbefthei.supabase.co/functions/v1/add-shop', {
      method: 'POST',
      headers: {
...
,
      ...
      body: JSON.stringify({
        ...
        coordinates: [parseFloat(latInput.value), parseFloat(lngInput.value)]
      })
    })
